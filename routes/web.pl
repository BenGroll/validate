...
use Http::Route;
use Validate::Http::Controllers::Controller;
...
Http::Route::group({
    ...
    Http::Route::group({
        ...
        Http::Route::get('/messages/{id}', sub {
            ...
            return Validate::Http::Controllers::Controller->new()->showMessage(
                $request,
            );
        ...
        Http::Route::group({
            ...
            Http::Route::get('/', sub {
                ...
                return Validate::Http::Controllers::Controller->new()->dashboard(
                    $request,
                );
